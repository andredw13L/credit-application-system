...
class CreditRepositoryTest {
    ...
    @Autowired
    lateinit var creditRepositoryTest: CreditRepositoryTest
    @Autowired
    ...
    @Test
    fun `should find all credit by costumer id`() {
        // Given
    ...
    private fun buildCredit(
        ...
        dayFirstInstallment: LocalDate = LocalDate.of(2023, Month.JUNE, 14),
